...
# Modules
> Generated 2026-08-02 13:52 UTC -- recursive src/ walk, 597 modules.
...
| `firmware/` | `loader` | 339 | efi.h, fw_agi_attest.h, sha256.h, stddef.h, stdint.h | loader.c -- WuBuOS WuBuFW chainloader (the REAL kernel as measured payload). This is the bridge betw |
...
| `kernel/` | `ahci` | 343 | ahci.h, stdio.h, stdlib.h, string.h | ahci.c  --  WuBuOS AHCI (SATA) Disk Driver Implementation Cell 072: AHCI driver with hosted simulati |
| `kernel/` | `ahci_test` | 471 | ahci.h, stdio.h, stdlib.h, string.h | ahci_test.c  --  Test Suite for WuBuOS AHCI (SATA) Disk Driver Cell 072: Tests HBA init, port enumer |
...
| `kernel/` | `fat32_dir` | 355 | fat32_internal.h, stdlib.h, string.h, time.h, wubu_lfn.h | fat32_dir.c -- directory enumeration, lookup, create, delete (leaf module). Opaque fat32_volume via  |
| `kernel/` | `fat32_fat` | 88 | fat32_internal.h, stdlib.h, string.h | fat32_fat.c -- FAT entry read/write + cache (leaf module). Opaque fat32_volume via fat32_internal.h. |
...
| `kernel/` | `fat32_format` | 240 | fat32_internal.h, stdlib.h, string.h, time.h | fat32_format.c -- mount/unmount/format/validate (volume lifecycle, leaf module). Opaque fat32_volume |
...
| `kernel/` | `interrupt` | 715 | interrupt.h, interrupt_apic.h, interrupt_io.h, interrupt_pic.h, memory.h, signal | interrupt.c  --  My Seed IDT/PIC Interrupt Controller Full x86_64 IDT implementation with 256 interr |
...
| `kernel/` | `metal_main` | 400 | input.h, interrupt.h, interrupt_apic.h, klog.h, memory.h, ps2.h, stdint.h, taski | metal_main.c  --  WuBuOS Bare-Metal Kernel Entry Point Called from crt0.S after Limine/Stivale2 boot |
...
| `kernel/` | `test_acpi` | 96 | stdint.h, stdio.h, stdlib.h, string.h, wubu_acpi.c | test_acpi.c -- host tests for wubu_acpi (RSDP -> RSDT/XSDT -> FADT). The RSDP scan targets the EBDA/ |
...
| `kernel/` | `test_agi_kernel_stub` | 74 | input.h, klog.h, stdio.h, tasking.h, vbe.h, wubu_sync.h | test_agi_kernel_stub.c -- Minimal kernel-API shims so wubu_agi_kernel.c links + runs in the HOSTED u |
...
| `kernel/` | `wubu_agi_kernel` | 440 | klog.h, string.h, tasking.h, vbe.h, wubu_agi_kernel.h, wubu_attest.h, wubu_bonzi | wubu_agi_kernel.c -- WuBuOS Bare-Metal AGI Kernel Supervisor (ring-0). Freestanding C11: NO malloc,  |
...
| `kernel/` | `wubu_console` | 689 | ahci.h, fat32.h, klog.h, libc.h, memory.h, stdint.h, string.h, tasking.h, wubu_a | wubu_console.c -- live ring-0 console REPL (TempleOS-style). The metal kernel owns a COM1 interactiv |
...
| `kernel/` | `wubu_lfn` | 186 | string.h, wubu_lfn.h | wubu_lfn.c  --  FAT32 VFAT Long File Name codec (self-contained) Gap A16. VFAT LFN layout per entry  |
