...
| `libc` | 544 | 4 | klog.h, stdarg.h, stddef.h, stdint.h | Minimal libc for bare-metal kernel |
...
| `metal_main` | 338 | 4 | input.h, interrupt.h, interrupt_apic.h, klog.h, memory.h, ps2.h, stdint.h, tasking.h, vbe. | metal_main.c  --  WuBuOS Bare-Metal Kernel Entry Point Called from crt0.S after Limine/Stivale2 boot. Initiali |
| `ps2` | 220 | 2 | input.h, interrupt.h, ps2.h, stdint.h | ps2.c  --  PS/2 Keyboard and Mouse Driver (Bare Metal) Ported from Mythos Fable (filipvabrousek/osdev) for WuB |
...
| `wubu_bonzi` | 355 | 0 | input.h, klog.h, stdio.h, string.h, tasking.h, vbe.h, wubu_agi_kernel.h, wubu_attest.h, wu | wubu_bonzi.c -- Bonzi Buddy: bare-metal AGI agent persona (ring-0 task). Freestanding C11. Runs as a kernel ta |
| `wubu_console` | 225 | 0 | klog.h, libc.h, memory.h, stdint.h, string.h, tasking.h, wubu_agi_kernel.h, wubu_console.h | wubu_console.c -- live ring-0 console REPL (TempleOS-style). The metal kernel owns a COM1 interactive shell: p |
