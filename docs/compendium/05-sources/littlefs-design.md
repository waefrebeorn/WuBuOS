[Skip to content](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md) to refresh your session.Dismiss alert

{{ message }}

### Uh oh!

There was an error while loading. [Please reload this page](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md).

[zephyrproject-rtos](https://github.com/zephyrproject-rtos)/ **[littlefs](https://github.com/zephyrproject-rtos/littlefs)** Public

- [Notifications](https://github.com/login?return_to=%2Fzephyrproject-rtos%2Flittlefs) You must be signed in to change notification settings
- [Fork\\
20](https://github.com/login?return_to=%2Fzephyrproject-rtos%2Flittlefs)
- [Star\\
19](https://github.com/login?return_to=%2Fzephyrproject-rtos%2Flittlefs)
...
![zchen24](https://avatars.githubusercontent.com/u/2781007?v=4&size=40)![geky](https://avatars.githubusercontent.com/u/1075160?v=4&size=40)

[zchen24](https://github.com/zephyrproject-rtos/littlefs/commits?author=zchen24)

and

[geky](https://github.com/zephyrproject-rtos/littlefs/commits?author=geky)

[Update DESIGN.md, fix minor typo](https://github.com/zephyrproject-rtos/littlefs/commit/99b84ee3db9ff1af25fe7194079b312e3a76ca61)

3 years agoDec 21, 2023

[99b84ee](https://github.com/zephyrproject-rtos/littlefs/commit/99b84ee3db9ff1af25fe7194079b312e3a76ca61) · 3 years agoDec 21, 2023

## History

[History](https://github.com/zephyrproject-rtos/littlefs/commits/zephyr/DESIGN.md)

Open commit details

[View commit history for this file.](https://github.com/zephyrproject-rtos/littlefs/commits/zephyr/DESIGN.md) History

2173 lines (1904 loc) · 94 KB
...
[Raw](https://github.com/zephyrproject-rtos/littlefs/raw/refs/heads/zephyr/DESIGN.md)
...
[Permalink: The design of littlefs](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md#the-design-of-littlefs)
...
low-level details covering every bit on disk, check out [SPEC.md](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/SPEC.md).

## The problem

[Permalink: The problem](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md#the-problem)
...
[Wikipedia](https://en.wikipedia.org/wiki/Flash_memory) has more information on how exactly flash works.
...
3. **Bounded RAM/ROM** \- If the above requirements weren't enough, these
...
[Permalink: Existing designs?](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md#existing-designs)
...
1. First we have the non-resilient, block based filesystems, such as [FAT](https://en.wikipedia.org/wiki/Design_of_the_FAT_file_system) and
[ext2](http://e2fsprogs.sourceforge.net/ext2intro.html). These are the earliest filesystem designs and often the most simple.
...
[JFFS](https://www.sourceware.org/jffs2/jffs2-html), [YAFFS](https://yaffs.net/documents/how-yaffs-works), and [SPIFFS](https://github.com/pellepl/spiffs/blob/master/docs/TECH_SPEC), storage location is not bound to a piece of
...
filesystem. [ext4](https://ext4.wiki.kernel.org/index.php/Ext4_Design) and [NTFS](https://en.wikipedia.org/wiki/NTFS) are good examples. Here, we take a normal
...
[btrfs](https://btrfs.wiki.kernel.org/index.php/Btrfs_design) and [ZFS](https://en.wikipedia.org/wiki/ZFS). These are very similar to other block based filesystems,
...
[Permalink: littlefs](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md#littlefs)
...
[Permalink: Metadata pairs](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md#metadata-pairs)
...
revision count that we compare using [sequence arithmetic](https://en.wikipedia.org/wiki/Serial_number_arithmetic)
...
use a 32-bit [CRC](https://en.wikipedia.org/wiki/Cyclic_redundancy_check). Maintaining redundancy, on the other hand,
...
Looking at the problem generically, consider a log with ![n](https://camo.githubusercontent.com/c05d006f23dbd03b26487ceb207e1bf07e8382a4c163e98efdb0f52dff8e5fce/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f6e) bytes for each
entry, ![d](https://camo.githubusercontent.com/644d9b1cadce2b48a4d50adda121ff7c540ec76d632de8b43ebaad2c238dbd21/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f64) dynamic entries (entries that are outdated during garbage
collection), and ![s](https://camo.githubusercontent.com/f1a81d3c4ca08d0b26da2f55f8c948f156bc59363ffd8cf8e81fccf23874a19f/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f73) static entries (entries that need to be copied during
garbage collection). If we look at the amortized runtime complexity of updating
this log we get this formula:

![cost = n + n (s / d+1)](https://camo.githubusercontent.com/6e8193c5ca9c35f5ee148bab3fbd11f494a528e1a4141e0cbe243f42b2a40228/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f636f73742532302533442532306e2532302b2532306e2532302535436672616325374273253744253742642b31253744)

If we let ![r](https://camo.githubusercontent.com/fe2d4b6b4d72bacf7a2471426b700c75faeed42e3cb3d05050211c23ccd814c4/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f72) be the ratio of static space to the size of our log in bytes, we
find an alternative representation of the number of static and dynamic entries:

![s = r (size/n)](https://camo.githubusercontent.com/66cd56192ca780629a13be51fda4998387411cbc109ec3db036309551737997e/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f73253230253344253230722532302535436672616325374273697a652537442537426e253744)

![d = (1 - r) (size/n)](https://camo.githubusercontent.com/c88f9182e3dddc17dc049d56e5a9f2cc977fa8c8e05c1e79fb6c05d78ffc913f/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f64253230253344253230253238312d722532392532302535436672616325374273697a652537442537426e253744)

Substituting these in for ![d](https://camo.githubusercontent.com/644d9b1cadce2b48a4d50adda121ff7c540ec76d632de8b43ebaad2c238dbd21/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f64) and ![s](https://camo.githubusercontent.com/f1a81d3c4ca08d0b26da2f55f8c948f156bc59363ffd8cf8e81fccf23874a19f/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f73) gives us a nice formula for the cost of
updating an entry given how full the log is:

![cost = n + n (r (size/n) / ((1-r) (size/n) + 1))](https://camo.githubusercontent.)

Assuming 100 byte entries in a 4 KiB log, we can graph this using the entry
size to find a multiplicative cost:

![Metadata pair update cost graph](https://raw.githubusercontent.com/geky/littlefs/gh-images/metadata-cost.svg?sanitize=true)
...
[Permalink: CTZ skip-lists](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md#ctz-skip-lists)
...
[Copy-on-write data structures](https://en.wikipedia.org/wiki/Copy-on-write), also called purely functional
...
[B-trees](https://en.wikipedia.org/wiki/B-tree), which can not be traversed with constant RAM, and
[B+-trees](https://en.wikipedia.org/wiki/B%2B_tree), which are not possible to update with COW
operations.
...
[skip-list](https://en.wikipedia.org/wiki/Skip_list). However, unlike the most common type of
...
The name comes from heavy use of the [CTZ instruction](https://en.wikipedia.org/wiki/Count_trailing_zeros), which
...
So now we have a [COW](https://upload.wikimedia.org/wikipedia/commons/0/0c/Cow_female_black_white.jpg) data structure that is cheap to append with a runtime
...
![lim,n->inf((1/n)sum,i,0->n(ctz(i)+1)) = sum,i,0->inf(1/2^i) = 2](https://camo.githubusercontent.)
...
following equation. Note that both a smaller block size ( ![B](https://camo.githubusercontent.com/cf03203883ce3e712c90490b6984db727d8b2d7b95eb892e0ddaabeb6c761cc6/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f42)) and larger
word width ( ![w](https://camo.githubusercontent.com/877dd17c880766fa54186a6629fa04e636e3b8b80b6c94334a0aefa143c027df/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f77)) result in more storage overhead.

![B = (w/8)ceil(log2(2^w / (B-2w/8)))](https://camo.githubusercontent.)

Solving the equation for ![B](https://camo.githubusercontent.com/cf03203883ce3e712c90490b6984db727d8b2d7b95eb892e0ddaabeb6c761cc6/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f42) gives us the minimum block size for some
common word widths:
...
up until our given size. Let ![B](https://camo.githubusercontent.com/cf03203883ce3e712c90490b6984db727d8b2d7b95eb892e0ddaabeb6c761cc6/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f42) be the block size in bytes, ![w](https://camo.githubusercontent.com/877dd17c880766fa54186a6629fa04e636e3b8b80b6c94334a0aefa143c027df/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f77) be the
word width in bits, ![n](https://camo.githubusercontent.com/c05d006f23dbd03b26487ceb207e1bf07e8382a4c163e98efdb0f52dff8e5fce/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f6e) be the index of the block in the skip-list, and
![N](https://camo.githubusercontent.com/c7deb3f059d5dc35008317bbcfa128365f02e6e2a8b7d325993b22ed52c1391c/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f4e) be the file size in bytes:

![N = sum,i,0->n(B-(w/8)(ctz(i)+1))](https://camo.githubusercontent.)
...
the [On-Line Encyclopedia of Integer Sequences (OEIS)](https://oeis.org/), I managed to find
[A001511](https://oeis.org/A001511), which matches the iteration of the CTZ instruction,
and [A005187](https://oeis.org/A005187), which matches its partial summation. Much to my
...
![sum,i,0->n(ctz(i)+1) = 2n-popcount(n)](https://camo.githubusercontent.)

where:

1. ctz( ![x](https://camo.githubusercontent.com/b233657f77218ae15324fbe2e0d905c6d5f784a314771cebc95e46a317ddc6f0/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f78)) = the number of trailing bits that are 0 in ![x](https://camo.githubusercontent.com/b233657f77218ae15324fbe2e0d905c6d5f784a314771cebc95e46a317ddc6f0/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f78)
2. popcount( ![x](https://camo.githubusercontent.com/b233657f77218ae15324fbe2e0d905c6d5f784a314771cebc95e46a317ddc6f0/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f78)) = the number of bits that are 1 in ![x](https://camo.githubusercontent.com/b233657f77218ae15324fbe2e0d905c6d5f784a314771cebc95e46a317ddc6f0/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f78)

Initial tests of this surprising property seem to hold. As ![n](https://camo.githubusercontent.com/c05d006f23dbd03b26487ceb207e1bf07e8382a4c163e98efdb0f52dff8e5fce/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f6e) approaches
...
![N = Bn - (w/8)(2n-popcount(n))](https://camo.githubusercontent.)

Unfortunately, the popcount function is non-injective, so we can't solve this
equation for our index. But what we can do is solve for an ![n'](https://camo.githubusercontent.com/6176e2e527a712773c02f92e094ae537803cbfbbbc1a01dd74e9b4337ce675dd/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f6e253237) index that
is greater than ![n](https://camo.githubusercontent.com/c05d006f23dbd03b26487ceb207e1bf07e8382a4c163e98efdb0f52dff8e5fce/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f6e) with error bounded by the range of the popcount function.
We can repeatedly substitute ![n'](https://camo.githubusercontent.com/6176e2e527a712773c02f92e094ae537803cbfbbbc1a01dd74e9b4337ce675dd/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f6e253237) into the original equation until the error
...
![n = floor((N-(w/8)popcount(N/(B-2w/8))) / (B-2w/8))](https://camo.githubusercontent.)

Now that we have our index ![n](https://camo.githubusercontent.com/c05d006f23dbd03b26487ceb207e1bf07e8382a4c163e98efdb0f52dff8e5fce/68747470733a2f2f6c617465782e636f6465636f67732e636f6d2f7376672e6c617465783f6e), we can just plug it back into the above
...
![off = N - (B-2w/8)n - (w/8)popcount(n)](https://camo.githubusercontent.)
...
[Permalink: The block allocator](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md#the-block-allocator)
...
But now we need to look at the [elephant](https://upload.wikimedia.org/wikipedia/commons/3/37/African_Bush_Elephant.jpg) in the room. Where do all these
blocks come from?
...
it on the floor" strategy store a bitmap of the entire storage in [RAM](https://upload.wikimedia.org/wikipedia/commons/9/97/New_Mexico_Bighorn_Sheep.JPG). This
...
[Permalink: Wear leveling](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md#wear-leveling)
...
[error-correction-codes (ECC)](https://en.wikipedia.org/wiki/Error_correction_code).
...
can detect: the [Hamming bound](https://en.wikipedia.org/wiki/Hamming_bound). As the number of
...
1. [Dynamic wear leveling](https://en.wikipedia.org/wiki/Wear_leveling#Dynamic_wear_leveling), where we
distribute wear over "dynamic" blocks. The can be accomplished by
only considering unused blocks.

2. [Static wear leveling](https://en.wikipedia.org/wiki/Wear_leveling#Static_wear_leveling), where we
...
![Cumulative wear distribution graph](https://raw.githubusercontent.com/geky/littlefs/gh-images/wear-distribution.svg?sanitize=true)
...
[flash translation layer (FTL)](https://en.wikipedia.org/wiki/Flash_translation_layer) to get a small power resilient
filesystem with static wear leveling.

## Files

[Permalink: Files](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md#files)
...
![File storage cost graph](https://raw.githubusercontent.com/geky/littlefs/gh-images/file-cost.svg?sanitize=true)

## Directories

[Permalink: Directories](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md#directories)
...
[RAM](https://upload.wikimedia.org/wikipedia/commons/9/97/New_Mexico_Bighorn_Sheep.JPG). The directory tree is a tree, and the unfortunate fact is you can't
...
[Permalink: The move problem](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md#the-move-problem)
...
[Permalink: Conclusion](https://github.com/zephyrproject-rtos/littlefs/blob/zephyr/DESIGN.md#conclusion)
