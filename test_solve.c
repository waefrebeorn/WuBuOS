...
int main() {
    ...
    EOMContext* ctx = ctx_create(7);
    printf("Context created\n");
    fflush(stdout);

    int result = solve_pole(7, ctx);
    printf("Result: %d\n", result);
