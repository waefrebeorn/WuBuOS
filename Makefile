...
test_snapshot:
	$(CC) -O0 -g -std=c11 -D_POSIX_C_SOURCE=200809L \
		-I$(RT) -I$(COMP) -I$(JIT) \
		$(RT)/wubu_snapshot.c $(RT)/wubu_snapshot_diff.c $(RT)/wubu_snapshot_fs.c $(RT)/wubu_snapshot_copy.c $(RT)/wubu_snapshot_tag.c $(RT)/wubu_snapshot_test.c \
...
test_system:
	$(CC) -O0 -g -std=c11 -D_POSIX_C_SOURCE=200809L \
		-I$(RT) -I$(COMP) -I$(JIT) \
		$(RT)/wubu_snapshot.c $(RT)/wubu_snapshot_diff.c $(RT)/wubu_snapshot_fs.c $(RT)/wubu_snapshot_copy.c $(RT)/wubu_snapshot_tag.c $(RT)/wubu_system.c $(RT)/wubu_system_test.c \
