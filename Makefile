...
# ── App Objects ──────────────────────────────────────────────────
APP_OBJS = $(APPS)/repl.o $(APPS)/notepad.o $(APPS)/wubu_editor.o $(APPS)/wubu_editor_bookmark.o $(APPS)/wubu_canvas.o $(APPS)/wubu_canvas_io.o $(APPS)/wubu_codec.o $(APPS)/dosgui_apps.o \
...
$(APPS)/wubu_editor.c $(APPS)/wubu_editor_bookmark.c $(APPS)/wubu_canvas.c $(APPS)/wubu_canvas_io.c $(APPS)/wubu_codec.c $(RT)/wubu_spawn.c \
