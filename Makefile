...
test_network:
	$(CC) -O0 -g -std=c11 -D_POSIX_C_SOURCE=200809L \
		-I$(RT) -I$(COMP) -I$(JIT) \
		$(RT)/wubu_network.c $(RT)/wubu_network_fw.c $(RT)/wubu_network_svc.c $(RT)/wubu_network_cni.c $(RT)/wubu_network_wg.c $(RT)/wubu_network_ts.c $(RT)/wubu_network_dns.c $(RT)/wubu_network_qos.c $(RT)/wubu_netlink.c $(RT)/wubu_spawn.c $(RT)/wubu_network_test.c \
