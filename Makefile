...
paint: $(APP_OBJS) $(GUI_OBJS) $(KERNEL_OBJS) $(JIT_OBJS)
	$(CC) $(CFLAGS) -I$(APPS) -I$(GUI) -I$(KERNEL) -I$(JIT) -I$(HOSTED) \
		...
		$(RT)/styx.o $(RT)/styxfs.o $(RT)/styxfs_util.o $(RT)/wubu_container.o $(RT)/wubu_exec.o $(RT)/wubu_host_exec.o $(RT)/wubu_ct_isolate.o $(RT)/wubu_ct_isolate_cgroup.o $(RT)/wubu_ct_bwrap.o $(KERNEL)/wubu_gaad.o $(RT)/wubu_arch.o \
		$(APP_OBJS) \
...
HOSTED_OBJS = \
	...
	$(RT)/styx.o $(RT)/styxfs.o $(RT)/styxfs_util.o \
	...
	$(RT)/wubu_host_exec.o $(RT)/wubu_ct_isolate.o $(RT)/wubu_ct_isolate_cgroup.o $(RT)/wubu_ct_bwrap.o $(RT)/wubu_exec.o \
...
test_wubu: $(JIT_OBJS) $(RT)/wubu_host_exec.o $(RT)/styxfs.o $(RT)/styxfs_util.o $(RT)/styx.o $(RT)/wubu_ct_isolate.o
	$(CC) -O0 -g -I$(RT) -I$(COMP) -I$(JIT) $(JIT_SRCS) $(RT)/wubu_spawn.c $(COMP)/holyc_lexer.c $(COMP)/holyc_parse.c $(COMP)/holyc_codegen.c $(COMP)/holyc_codegen_emit.c $(COMP)/holyc_codegen_expr.c $(COMP)/holyc_codegen_stmt.c $(COMP)/holyc_codegen_api.c $(RT)/wubu_container.c $(RT)/wubu_exec.c $(RT)/wubu_host_exec.c $(RT)/wubu_ct_isolate.c $(RT)/wubu_ct_isolate_cgroup.c $(RT)/styx.c $(RT)/styxfs.c $(RT)/styxfs_util.c $(RT)/wubu_container_test.c -o $(RT)/wubu_container_test -ldl
...
test_syscall:
	$(CC) -O0 -g -std=c11 -D_GNU_SOURCE -I$(BRIDGE) -I$(KERNEL) -I$(GUI) -I$(RT) -I$(COMP) -I$(JIT) -DMYSEED_METAL \
		$(JIT_SRCS) $(RT)/wubu_spawn.c $(COMP)/holyc_lexer.c $(COMP)/holyc_parse.c $(COMP)/holyc_codegen.c $(COMP)/holyc_codegen_emit.c $(COMP)/holyc_codegen_expr.c $(COMP)/holyc_codegen_stmt.c $(COMP)/holyc_codegen_api.c \
		$(RT)/wubu_container.c $(RT)/wubu_exec.c $(RT)/wubu_host_exec.c $(RT)/wubu_ct_isolate.c $(RT)/wubu_ct_isolate_cgroup.c \
		$(RT)/styx.c $(RT)/styxfs.c $(RT)/styxfs_util.c \
...
test_launch:
	$(CC) -O0 -g -std=c11 -D_POSIX_C_SOURCE=200809L \
		...
		$(RT)/wubu_host_exec.c $(RT)/wubu_session.c $(RT)/styx.o $(RT)/styxfs.o $(RT)/styxfs_util.o \
...
test_gui_screenshot:
	$(CC) -O0 -g -std=c11 -D_POSIX_C_SOURCE=200809L -DVBE_HOSTED -DWUBU_NO_LIBM -DWUBU_SCREENSHOT_WITH_WM \
		...
		$(GUI)/dosgui_wm.c $(GUI)/dosgui_wm_ctxmenu.c $(GUI)/dosgui_wm_systray.c $(GUI)/dosgui_wm_holyc_term.c $(GUI)/dosgui_wm_taskbar.c $(GUI)/dosgui_wm_desktop.c $(GUI)/dosgui_wm_icons.c $(GUI)/wubu_wm.c $(HOSTED)/hosted.c $(RT)/styx.c $(RT)/styxfs.c $(RT)/styxfs_util.c \
...
test_styxfs:
	$(CC) $(CFLAGS) -O0 -g -std=c11 -I$(RT) -I$(COMP) -I$(JIT) $(JIT_SRCS) $(RT)/wubu_spawn.c $(COMP)/holyc_lexer.c $(COMP)/holyc_parse.c $(COMP)/holyc_codegen.c $(COMP)/holyc_codegen_emit.c $(COMP)/holyc_codegen_expr.c $(COMP)/holyc_codegen_stmt.c $(COMP)/holyc_codegen_api.c $(RT)/wubu_container.c $(RT)/wubu_exec.c $(RT)/wubu_host_exec.c $(RT)/wubu_ct_isolate.c $(RT)/wubu_ct_isolate_cgroup.c $(RT)/styx.c $(RT)/styxfs.c $(RT)/styxfs_util.c $(RT)/styxfs_test.c -o $(RT)/styxfs_test
	$(RT)/styxfs_test
...
test_hosted: $(HOSTED)/xdg-shell-private.o $(HOSTED)/primary-selection-private.o
	$(CC) -O0 -g -std=c11 -D_POSIX_C_SOURCE=200809L -DVBE_HOSTED -DWUBU_HOSTED_TEST -DWUBD_TEST_MAIN -I$(HOSTED) -I$(RT) -I$(KERNEL) -I$(BRIDGE) -I$(GUI) -I$(COMP) -I$(JIT) -I$(APPS) \
		$(HOSTED)/hosted_test.c $(HOSTED)/hosted.c $(RT)/styx.c $(RT)/styxfs.c $(RT)/styxfs_util.c $(KERNEL)/vbe.c $(KERNEL)/memory.c \
		...
		$(RT)/wubu_host_exec.c $(RT)/wubu_ct_isolate.c $(RT)/wubu_ct_isolate_cgroup.c $(RT)/wubu_ct_bwrap.c $(RT)/wubu_exec.c $(RT)/wubu_container.c $(RT)/wubu_compat_db.c $(RT)/wubu_session.c $(RT)/wubu_arch.c $(RT)/wubu_archd.c $(RT)/wubu_ramdisk.c \
		$(HOSTED)/xdg-shell-private.o $(HOSTED)/primary-selection-private.o \
...
test_host_exec:
	$(CC) -O0 -g -std=c11 -D_POSIX_C_SOURCE=200809L -I$(RT) \
		$(RT)/styx.c $(RT)/styxfs.c $(RT)/styxfs_util.c $(RT)/wubu_host_exec.c $(RT)/wubu_ct_isolate.c $(RT)/wubu_ct_isolate_cgroup.c $(RT)/wubu_container.c $(RT)/wubu_host_exec_test.c \
...
test_arch:
	$(CC) -O0 -g -std=c11 -D_POSIX_C_SOURCE=200809L \
		-I$(RT) -I$(APPS) \
		$(RT)/styx.c $(RT)/styxfs.c $(RT)/styxfs_util.c $(RT)/wubu_container.c $(RT)/wubu_arch.c $(RT)/wubu_host_exec.c $(RT)/wubu_ct_isolate.c $(RT)/wubu_ct_isolate_cgroup.c \
...
test_ramdisk:
	$(CC) -O0 -g -std=c11 -D_POSIX_C_SOURCE=200809L \
		-I$(RT) -I$(APPS) \
		$(RT)/styx.c $(RT)/styxfs.c $(RT)/styxfs_util.c $(RT)/wubu_container.c $(RT)/wubu_ramdisk.c $(RT)/wubu_arch.c $(RT)/wubu_host_exec.c $(RT)/wubu_ct_isolate.c $(RT)/wubu_ct_isolate_cgroup.c \
...
test_wubu_wm:
	$(CC) -O0 -g -std=c11 -D_POSIX_C_SOURCE=200809L -DVBE_HOSTED -DWUBU_NO_LIBM \
		-I$(GUI) -I$(KERNEL) -I$(RT) \
		$(RT)/styx.c $(RT)/styxfs.c $(RT)/styxfs_util.c $(GUI)/wubu_theme.c $(GUI)/wubu_wm.c \
...
$(APPS)/wubu_editor.c $(APPS)/wubu_canvas.c $(APPS)/wubu_canvas_io.c $(APPS)/wubu_codec.c $(RT)/wubu_spawn.c \
		$(RT)/wubu_host_exec.c $(RT)/wubu_ct_isolate.c $(RT)/wubu_ct_isolate_cgroup.c $(RT)/styx.c $(RT)/styxfs.c $(RT)/styxfs_util.c $(RT)/wubu_container.c \
...
test_proton2:
	$(CC) -O0 -g -std=c11 -D_POSIX_C_SOURCE=200809L \
		...
		$(RT)/wubu_host_exec.c $(RT)/wubu_container.c $(RT)/styx.c $(RT)/styxfs.c $(RT)/styxfs_util.c \
...
test_pkgmgr:
	$(CC) -O0 -g -std=c11 -D_POSIX_C_SOURCE=200809L -DWUBU_NO_LIBM \
		...
		$(RT)/styx.c $(RT)/styxfs.c $(RT)/styxfs_util.c $(RT)/wubu_container.c \
...
test_daemon_panel:
	$(CC) -O0 -g -std=c11 -D_POSIX_C_SOURCE=200809L -DWUBD_TEST_MAIN -Wno-format-truncation \
		...
		$(RT)/wubu_archd.c $(RT)/wubu_arch.c $(RT)/wubu_ramdisk.c \
		$(RT)/wubu_host_exec.c $(RT)/wubu_ct_isolate.c $(RT)/wubu_ct_isolate_cgroup.c \
		$(RT)/wubu_container.c $(RT)/styx.c $(RT)/styxfs.c $(RT)/styxfs_util.c \
