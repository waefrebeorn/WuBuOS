...
/* Win32->VSL API translation table + register/translate/load APIs moved to
 * wubu_proton_api.c. */
...
int wubu_proton_init(wubu_proton_t *p) {
    ...
    wubu_proton_load_default_dlls(p);
...
/* API register/translate/load-default moved to wubu_proton_api.c. */
