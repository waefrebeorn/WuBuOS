...
void vsl_nt_wnf_register(vsl_syscall_fn_t *tbl, int tbl_size) {
    (void)tbl_size;
    tbl[212-1] = vsl_nt_create_wnf_state_name;
    tbl[224-1] = vsl_nt_delete_wnf_state_data;
    tbl[225-1] = vsl_nt_delete_wnf_state_name;
    tbl[249-1] = vsl_nt_get_complete_wnf_state_subscription;
    tbl[368-1] = vsl_nt_query_wnf_state_data;
    tbl[369-1] = vsl_nt_query_wnf_state_name_information;
    tbl[453-1] = vsl_nt_set_wnf_process_notification_event;
    tbl[461-1] = vsl_nt_subscribe_wnf_state_change;
    tbl[480-1] = vsl_nt_unsubscribe_wnf_state_change;
    tbl[481-1] = vsl_nt_update_wnf_state_data;
}
