...
void vsl_nt_ktm_register(vsl_syscall_fn_t *tbl, int tbl_size) {
    (void)tbl_size;
    tbl[154-1] = vsl_nt_commit_complete;
    tbl[155-1] = vsl_nt_commit_enlistment;
    tbl[156-1] = vsl_nt_commit_registry_transaction;
    tbl[157-1] = vsl_nt_commit_transaction;
    tbl[175-1] = vsl_nt_create_enlistment;
    tbl[196-1] = vsl_nt_create_registry_transaction;
    tbl[197-1] = vsl_nt_create_resource_manager;
    tbl[207-1] = vsl_nt_create_transaction;
    tbl[208-1] = vsl_nt_create_transaction_manager;
    tbl[233-1] = vsl_nt_enumerate_transaction_object;
    tbl[247-1] = vsl_nt_freeze_transactions;
    tbl[258-1] = vsl_nt_get_notification_resource_manager;
    tbl[295-1] = vsl_nt_open_enlistment;
    tbl[308-1] = vsl_nt_open_registry_transaction;
    tbl[309-1] = vsl_nt_open_resource_manager;
    tbl[315-1] = vsl_nt_open_transaction;
    tbl[316-1] = vsl_nt_open_transaction_manager;
    tbl[318-1] = vsl_nt_pre_prepare_complete;
    tbl[319-1] = vsl_nt_pre_prepare_enlistment;
    tbl[320-1] = vsl_nt_prepare_complete;
    tbl[321-1] = vsl_nt_prepare_enlistment;
    tbl[326-1] = vsl_nt_propagation_failed;
    tbl[341-1] = vsl_nt_query_information_enlistment;
    tbl[344-1] = vsl_nt_query_information_resource_manager;
    tbl[345-1] = vsl_nt_query_information_transaction;
    tbl[346-1] = vsl_nt_query_information_transaction_manager;
    tbl[374-1] = vsl_nt_read_only_enlistment;
    tbl[376-1] = vsl_nt_recover_enlistment;
    tbl[377-1] = vsl_nt_recover_resource_manager;
    tbl[378-1] = vsl_nt_recover_transaction_manager;
    tbl[379-1] = vsl_nt_register_protocol_address_information;
    tbl[386-1] = vsl_nt_rename_transaction_manager;
    tbl[396-1] = vsl_nt_rollback_complete;
    tbl[397-1] = vsl_nt_rollback_enlistment;
    tbl[398-1] = vsl_nt_rollback_registry_transaction;
    tbl[399-1] = vsl_nt_rollback_transaction;
    tbl[400-1] = vsl_nt_rollforward_transaction_manager;
    tbl[423-1] = vsl_nt_set_information_enlistment;
    tbl[427-1] = vsl_nt_set_information_resource_manager;
    tbl[430-1] = vsl_nt_set_information_transaction;
    tbl[431-1] = vsl_nt_set_information_transaction_manager;
    tbl[469-1] = vsl_nt_thaw_transactions;
}
