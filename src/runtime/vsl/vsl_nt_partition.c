...
void vsl_nt_partition_register(vsl_syscall_fn_t *tbl, int tbl_size) {
    (void)tbl_size;
    tbl[168-1] = vsl_nt_create_cpu_partition;
    tbl[189-1] = vsl_nt_create_partition;
    tbl[282-1] = vsl_nt_manage_partition;
    tbl[294-1] = vsl_nt_open_cpu_partition;
    tbl[305-1] = vsl_nt_open_partition;
    tbl[340-1] = vsl_nt_query_information_cpu_partition;
    tbl[388-1] = vsl_nt_replace_partition_unit;
    tbl[421-1] = vsl_nt_set_information_cpu_partition;
}
