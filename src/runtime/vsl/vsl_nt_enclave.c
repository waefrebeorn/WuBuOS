...
void vsl_nt_enclave_register(vsl_syscall_fn_t *tbl, int tbl_size) {
    (void)tbl_size;
tbl[325-1] = vsl_nt_create_enclave;
tbl[326-1] = vsl_nt_initialize_enclave;
tbl[327-1] = vsl_nt_load_enclave_data;
tbl[328-1] = vsl_nt_terminate_enclave;
tbl[324-1] = vsl_nt_call_enclave;
}
