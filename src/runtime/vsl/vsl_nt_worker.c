...
void vsl_nt_worker_register(vsl_syscall_fn_t *tbl, int tbl_size) {
    ...
    tbl[213-1] = vsl_nt_create_worker_factory;
    tbl[347-1] = vsl_nt_query_information_worker_factory;
    tbl[382-1] = vsl_nt_release_worker_factory_worker;
    tbl[433-1] = vsl_nt_set_information_worker_factory;
    tbl[455-1] = vsl_nt_shutdown_worker_factory;
    tbl[486-1] = vsl_nt_wait_for_work_via_worker_factory;
    /* tbl[1-1] = vsl_nt_worker_factory_worker_ready; -- W11-only ordinal */
}
