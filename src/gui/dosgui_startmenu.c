...
/* Main-menu + submenu construction moved to dosgui_startmenu_db.c
 * (dosgui_startmenu_build_main_menu / dosgui_startmenu_build_submenus). */
...
void dosgui_startmenu_init_enhanced(void) {
    dosgui_startmenu_build_main_menu();
    dosgui_startmenu_build_submenus();
