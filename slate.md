...
- **E1 ReactOS NT: 297** syscalls mapped, **148 transliterated** (batch 1 = 10, batch 2 = 10, batch 3 = 10, batch 4 = 4, batch 5 = 6, batch 6 = 10, batch 7 = 8, batch 8 = 8, blitz = 22, batch 11 = 24, 2026-07-19). 149 remain.
...
- **Still open from v22 board**: stub-phrase no-ops (`tasking.c`×2, `wubu_anticheat.c`×2,
  ...
  `wubu_bottles.c`); bare-metal no-ops (`tasking.c`×3). E1 ReactOS NT: 148/297
