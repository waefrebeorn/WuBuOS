...
# ── Compiler Objects ─────────────────────────────────────────────
COMP_OBJS = $(COMP)/holyc_lexer.o $(COMP)/holyc_parse.o $(COMP)/holyc_parse_ast.o $(COMP)/holyc_codegen.o $(COMP)/holyc_codegen_emit.o $(COMP)/holyc_codegen_expr.o $(COMP)/holyc_codegen_stmt.o $(COMP)/holyc_codegen_api.o $(COMP)/wubu_preproc.o $(COMP)/holyc_runtime.o $(COMP)/holyc_ptx.o $(COMP)/wubu_mir.o $(COMP)/wubu_mir_opt.o $(COMP)/wubu_mir_lower.o $(COMP)/x86_peephole.o $(COMP)/wubu_isa_driver.o $(COMP)/wubu_isa_x86_64.o $(COMP)/wubu_isa_arm64.o $(COMP)/wubu_isa_m68k.o $(COMP)/wubu_m68k_interp.o $(COMP)/wubu_isa_8086.o $(COMP)/wubu_isa_riscv.o $(RT)/wubu_riscv_interp.o $(COMP)/wubu_isa_6502.o $(RT)/wubu_6502_interp.o $(COMP)/wubu_isa_z80.o $(COMP)/wubu_z80_interp.o $(COMP)/wubu_isa_8051.o $(COMP)/wubu_8051_interp.o $(COMP)/wubu_isa_avr.o $(COMP)/wubu_avr_interp.o $(COMP)/wubu_isa_mips.o $(RT)/wubu_mips_interp.o $(COMP)/wubu_isa_ptx.o
