...
# ── Compiler Objects ─────────────────────────────────────────────
COMP_OBJS = $(COMP)/holyd_lexer.o $(COMP)/holyd_parse.o $(COMP)/holyd_parse_ast.o $(COMP)/holyd_codegen.o $(COMP)/holyd_codegen_emit.o $(COMP)/holyd_codegen_expr.o $(COMP)/holyd_codegen_stmt.o $(COMP)/holyd_codegen_api.o $(COMP)/wubu_preproc.o $(COMP)/holyd_runtime.o $(COMP)/holyd_ptx.o $(COMP)/wubu_mir.o $(COMP)/wubu_mir_opt.o $(COMP)/wubu_mir_lower.o $(COMP)/wubu_mir_regalloc.o $(COMP)/wubu_mir_interp.o $(COMP)/x86_peephole.o $(COMP)/wubu_softfloat.o $(COMP)/wubu_isa_driver.o $(COMP)/wubu_isa_x86_64.o $(COMP)/wubu_isa_arm64.o $(COMP)/wubu_isa_m68k.o $(COMP)/wubu_m68k_interp.o $(COMP)/wubu_isa_8086.o $(COMP)/wubu_isa_riscv.o $(RT)/wubu_riscv_interp.o $(COMP)/wubu_isa_6502.o $(RT)/wubu_6502_interp.o $(COMP)/wubu_isa_z80.o $(COMP)/wubu_z80_interp.o $(COMP)/wubu_isa_8051.o $(COMP)/wubu_8051_interp.o $(COMP)/wubu_isa_avr.o $(COMP)/wubu_avr_interp.o $(COMP)/wubu_isa_pic.o $(COMP)/wubu_pic_interp.o $(COMP)/wubu_isa_mips.o $(RT)/wubu_mips_interp.o $(COMP)/wubu_isa_ptx.o $(COMP)/wubu_isa_amdgpu.o $(COMP)/wubu_isa_jit_stubs.o $(COMP)/wubu_elf64_cubin.o $(COMP)/wubu_tgemm.o
