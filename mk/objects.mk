...
JIT_SRCS = $(JIT)/jit.c $(JIT)/jit_encode.c $(JIT)/wubu_x86.c $(JIT)/wubu_arm64.c $(JIT)/wubu_disasm.c $(JIT)/x86_regalloc.c $(JIT)/jit_codegen_x86.c $(JIT)/jit_minic.c $(JIT)/jit_minic_expr.c $(JIT)/jit_minic_token.c $(JIT)/jit_minic_type.c $(JIT)/jit_minic_loop.c $(JIT)/jit_branch_profile.c -ldl
...
# ── JIT Objects ──────────────────────────────────────────────────
JIT_OBJS = $(JIT)/jit.o $(JIT)/jit_encode.o $(JIT)/wubu_x86.o $(JIT)/wubu_arm64.o $(JIT)/wubu_disasm.o $(JIT)/x86_regalloc.o $(JIT)/jit_codegen_x86.o $(JIT)/jit_minic.o $(JIT)/jit_minic_expr.o $(JIT)/jit_minic_token.o
